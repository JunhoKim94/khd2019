...
if __name__ == '__main__':
    ...
    model = Xception(input_shape=(307, 390, 3), classes=4, include_top=True, weights=None, input_tensor=None, pooling=None)
    ...
    if config.mode == 'train':  ### training mode일 때
        ...
        nsml.load(checkpoint='15', session='team120/KHD2019_FUNDUS/166')
        nsml.save('best')
        ...
        datagen = ImageDataGenerator(rotation_range= 180 , horizontal_flip= True, vertical_flip= True,  shear_range= 0.2, height_shift_range= 0.2, width_shift_range= 0.2,
                                    dtype='float32')
        datagen.fit(x_train)
